...
const PLANS: Plan[] = [
  {
    ...
    comingSoon: false,
    features: [
      { text: "Full market platform access", included: true },
      { text: "Curated thematic watchlist", included: true },
      { text: "Themes & market leadership", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "1 custom watchlist (50 stocks)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "2 custom watchlists (100 stocks)", included: true },
  ...
  {
    name: "PRO",
    tagline: "Build your investing operating system",
    price: "$299",
    priceSuffix: "/ month",
    ...
    features: [
      ...
      { text: "Custom investing rules", included: true },
