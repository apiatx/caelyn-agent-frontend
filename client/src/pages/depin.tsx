      ...
      <main className="max-w-[95vw] mx-auto px-2 sm:px-3 py-4">
        <GlassCard className="p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">DePIN</h2>
          </div>
          <p className="text-gray-300 text-lg">
            Decentralized Physical Infrastructure Networks - Real-world infrastructure powered by blockchain technology.
          </p>
        </GlassCard>
      </main>
    </div>
