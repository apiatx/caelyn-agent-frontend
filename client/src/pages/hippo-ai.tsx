        ...
        <div className="space-y-4 lg:space-y-8">
          <GlassCard className="p-6 lg:p-8 text-center">
            <div className="flex justify-center mb-6">
              <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-yellow-400 shadow-2xl">
                <img src={cryptoHippoImage} alt="HippoAI" className="w-full h-full object-cover" />
              </div>
            </div>
