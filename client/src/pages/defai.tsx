      ...
      <main className="max-w-[95vw] mx-auto px-2 sm:px-3 py-4">
        <GlassCard className="p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">DeFAI</h2>
          </div>
          <p className="text-gray-300 text-lg">
            Decentralized Finance AI - AI-powered DeFi protocols, automated trading, and intelligent yield optimization.
          </p>
        </GlassCard>
      </main>
    </div>
