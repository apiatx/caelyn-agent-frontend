...
export default function StocksScreenersPage() {
          ...
          <div className="text-center relative mb-8">
            ...
            <div className="flex justify-center items-center gap-4 mb-6">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-yellow-400 shadow-2xl hover:scale-110 transition-transform duration-300">
                <img src={stonksIcon} alt="Screeners" className="w-full h-full object-cover" />
              </div>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-3 bg-gradient-to-r from-emerald-400 via-cyan-300 to-blue-400 bg-clip-text text-transparent">Screeners</h2>
            <Badge className="bg-gradient-to-r from-emerald-500/30 to-cyan-500/30 text-white border-emerald-400/50 text-sm px-4 py-1 mb-4">STOCK SCREENERS</Badge>
            <div className="w-32 h-1 bg-gradient-to-r from-emerald-500 to-cyan-500 mx-auto rounded-full mb-4"></div>
            <p className="text-lg text-white/80">AI-powered screeners and financial analytics</p>
          </div>
