...
function TickerTapeWidget() {
  ...
  useEffect(() => {
    ...
    if (doc) {
      doc.open();
      doc.write(`<!DOCTYPE html><html><head><style>body{margin:0;padding:0;overflow:hidden;background:transparent;}</style></head><body><script type="module" src="https://widgets.tradingview-widget.com/w/en/tv-ticker-tape.js"><\/script><tv-ticker-tape symbols="FOREXCOM:SPXUSD,FOREXCOM:NSXUSD,FOREXCOM:DJI,FX:EURUSD,BITSTAMP:BTCUSD,BITSTAMP:ETHUSD,CMCMARKETS:GOLD" style="width:100%;display:block;"></tv-ticker-tape></body></html>`);
      doc.close();
    }
    return () => {
      if (containerRef.current && iframe.parentNode === containerRef.current) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
            ...
            <GlassCard className="p-3 sm:p-4 lg:p-6">
              <div className="flex items-center gap-2 mb-6">
                ...
                <Badge className="bg-orange-500/20 text-orange-400 border-orange-500/30 text-xs">TRADINGVIEW</Badge>
              </div>
              <div className="w-full min-h-[560px] rounded-lg overflow-hidden border border-crypto-silver/20">
