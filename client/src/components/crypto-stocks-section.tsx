    ...
    <div className="space-y-4 lg:space-y-8">
      ...
      <GlassCard className="p-3 sm:p-4 lg:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-6">
          ...
          <button
            onClick={() => openInNewTab('https://www.tradingview.com/chart/e5l95XgZ/?symbol=FX%3ASPX500')}
        ...
        <div className="w-full">
          <iframe
            src="https://s.tradingview.com/widgetembed/?frameElementId=tradingview_e5l95&symbol=FX%3ASPX500&interval=D&hidesidetoolbar=1&hidetoptoolbar=1&symboledit=1&saveimage=1&toolbarbg=0a0a0a&studies=[]&hideideas=1&theme=dark&style=1&timezone=Etc%2FUTC&withdateranges=1&range=3M&allow_symbol_change=1&src=e5l95XgZ"
            className="w-full h-[500px] sm:h-[600px] lg:h-[700px] rounded-lg border border-crypto-silver/20"
            title="S&P 500 (FX:SPX500) Chart"
            frameBorder="0"
            scrolling="no"
            allow="fullscreen"
          />
