  ...
  return (
    <div className="space-y-4 lg:space-y-8">
      ...
      <GlassCard className="p-3 sm:p-4 lg:p-6">
        ...
        <div className="w-full">
          <iframe
            src="https://s.tradingview.com/widgetembed/?frameElementId=tradingview_e5l95&symbol=SP%3ASPX&interval=ALL&hidesidetoolbar=1&hidetoptoolbar=1&symboledit=1&saveimage=1&toolbarbg=0a0a0a&studies=[]&hideideas=1&theme=dark&style=1&timezone=Etc%2FUTC&withdateranges=1&range=ALL&allow_symbol_change=1&src=e5l95XgZ&exchange=SP"
