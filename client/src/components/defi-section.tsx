      ...
      <GlassCard className="p-6">
        <div className="flex flex-col items-center text-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-crypto-silver">Arbitrum DeFi ecosystem projects</p>
          </div>
        </div>

        <div className="flex justify-end mb-3">
          <SafeLink
            href="https://portal.arbitrum.io/projects/defi"
        ...
        <div className="bg-black/20 border border-crypto-silver/20 rounded-lg overflow-hidden">
          <iframe
            {...getSecureIframeProps('https://portal.arbitrum.io/projects/defi', 'Arbitrum DeFi Projects')}
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-gray-400">
            Arbitrum DeFi Projects Portal • Explore the Arbitrum ecosystem
          </p>
        </div>
      </GlassCard>
