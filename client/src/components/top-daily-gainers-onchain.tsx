...
const TopDailyGainersOnchain = () => {
  ...
  useEffect(() => {
    const fetchGainers = async () => {
      try {
        setIsLoading(true);
        const response = await fetch('/api/coinmarketcap/daily-gainers-onchain');
      ...
      <div className="mt-6 bg-black/40 backdrop-blur-lg border border-crypto-silver/20 rounded-xl p-6">
        <div className="flex flex-col items-center justify-center space-y-2 mb-4">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-semibold text-white">Top 20 Daily Gainers</h3>
          </div>
          <p className="text-sm text-crypto-silver">CMC Top 500</p>
        </div>
  ...
  return (
    <div className="mt-6 bg-black/40 backdrop-blur-lg border border-crypto-silver/20 rounded-xl p-6" data-testid="top-daily-gainers-onchain">
...
export default TopDailyGainersOnchain;