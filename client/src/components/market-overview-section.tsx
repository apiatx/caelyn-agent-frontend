...
export function MarketOverviewSection() {
  ...
  return (
    <div className="bg-black/20 border border-crypto-silver/20 rounded-lg p-4 sm:p-6">
      ...
      <div className="bg-black/40 backdrop-blur-lg border border-gray-700/50 rounded-lg p-3 sm:p-4 lg:p-6 mt-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-6">
          <div className="flex items-center gap-2">
            ...
            <span className="bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 rounded px-2 py-1 text-xs">
              LIQUIDITY
            </span>
          </div>
          <div className="flex items-center gap-2">
            ...
            >
              M2 / BTC <span className="text-indigo-400">↗</span>
            </button>
        ...
        <div className="w-full">
          <iframe
            ...
            className="w-full h-[400px] sm:h-[500px] lg:h-[600px] rounded-lg border border-gray-700/30"
