    ...
    <div className="space-y-12 p-6">
      ...
      <div className="text-center relative">
        ...
        <div className="flex justify-center items-center gap-4 mb-6">
          <div className="w-24 h-24 rounded-full flex items-center justify-center border-2 border-yellow-400 shadow-2xl hover:scale-110 transition-transform duration-300 overflow-hidden">
            <img 
              src={tradeIcon} 
              alt="Trade Icon" 
