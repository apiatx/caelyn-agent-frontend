    ...
    async def get_risk(self) -> dict:
        ...
        result = {
            ...
            "fear_greed": {
                ...
                "previous_close": fg.get("historical", {}).get("previous_close", {}).get("score") if fg.get("historical") else None,
                "one_week_ago": fg.get("historical", {}).get("one_week_ago", {}).get("score") if fg.get("historical") else None,
