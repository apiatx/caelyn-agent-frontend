    ...
    def _ask_claude(self, user_prompt: str, market_data: dict, history: list = None, is_followup: bool = False, category: str = "") -> str:
        ...
        if category == "crypto":
            crypto_preamble = (
                ...
                "DOMINANCE DATA: The 'dominance' object contains btc_dominance and eth_dominance (%). Include in btc_eth_summary:\n"
                "- BTC.d (BTC dominance %): Rising = capital rotating into BTC (flight to quality). Falling = alt season approaching.\n"
                "- ETH.d (ETH dominance %): Rising = DeFi/L2 ecosystem strength. Falling = ETH losing ground.\n"
                "Put the dominance % in each coin's 'dominance' field and in the 'dominance' sub-object of btc_eth_summary.\n\n"
                "PRICE CHANGES: Use change_7d and change_30d from top_coins/cmc_top data. Never show N/A if the data field exists.\n\n"
